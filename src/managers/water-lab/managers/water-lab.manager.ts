...
// Accessors
import type { IWaterParameterAccessor } from '@accessors/aquarium/accessors/water-parameter.accessor.interface';
import { WATER_PARAMETER_ACCESSOR } from '@accessors/aquarium/accessors/water-parameter.accessor.interface';
...
export class WaterLabManager {
  ...
  async logWaterParameters(
    dto: CreateWaterParameterRequest,
