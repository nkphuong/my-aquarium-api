...
const tankSetupSchema = z.object({
  ...
  filter: z.object({
    ...
    filter_media: z
      ...
      .nullable()
      .describe(
        'The filter media of the aquarium. You must suggest the high quality that can be bought in vietnam market.',
      ),
    filter_compartments: z
      .number()
      .nullable()
      .describe('The filter compartments of the aquarium.'),
  }),
  ...
  heating: z
    ...
    .nullable()
    .describe(
      'The heating of the aquarium that optimized with the fish and where user is living.',
    ),
  decorations: z
    .array(z.string().nullable())
    .describe('The decorations of the aquarium.'),
  livestock: z.object({
    fish: z
      .array(z.string().nullable())
      .describe('Number of fish of the aquarium.'),
    invertebrates: z
      .array(z.string().nullable())
      .describe('Number of invertebrates of the aquarium.'),
    plants: z
      .array(z.string().nullable())
      .describe('Number of plants of the aquarium.'),
  }),
  maintenance_schedule: z
    .string()
    .describe('The maintenance schedule of the aquarium.'),
});
