import { ICreateFishSpeciesCommand } from '../contracts/inventory.manager.interface';
...
const fishSpeciesSchema = z.object({
  ...
  gh_min: z
    .number()
    .describe('The minimum water hardness of the fish species.'),
  gh_max: z
    .number()
    .describe('The maximum water hardness of the fish species.'),
  ...
  scientific_name: z
    .string()
    .describe('The scientific name of the fish species.'),
  substrate_digger: z
    .boolean()
    .describe('The substrate digger of the fish species.'),
  ...
  min_school_size: z
    .number()
    .describe('The minimum school size of the fish species.'),
  size_max: z.number().describe('The maximum size of the fish species.'),
  min_tank_size: z
    .number()
    .describe('The minimum tank size of the fish species.'),
  temperament: z.string().describe('The temperament of the fish species.'),
  flow_preference: z
    .string()
    .describe('The flow preference of the fish species.'),
  image_url: z
    .string()
    .describe('The image URL of the fish species.')
    .optional(),
  aliases: z
    .array(z.string())
    .describe('List of aliases or common names for the fish species.')
    .optional(),
});
...
export class FishSpeciesEngine {
  getSystemInstruction(): string {
    return [
      ...
      'Your exsiting data is not correct with the reality, so you must use grounding tool to search about the fish species on fishbase.se.',
  ...
  prepareUserPrompt(fishSpeciesRequest: ICreateFishSpeciesCommand): string {
    const userPrompt = `
    Fish species:
