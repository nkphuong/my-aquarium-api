...
import { LivestockStatus } from '../enums/livestock.enum';
import {
  ICreateFishCommand,
  ICreateLivestockCommand,
  IUpdateLivestockCommand,
} from '../contracts/inventory.manager.interface';
...
import type { ILivestockAccessor } from '../contracts/livestock.accessor.interface';
