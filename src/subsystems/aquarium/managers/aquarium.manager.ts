...
import {
  ICreateTankCommand,
  IUpdateTankCommand,
} from '../contracts/aquarium.manager.interface';
import { Tank } from '../entities/tank.entity';
import { Fish } from '../entities/fish.entity';
import { PaginatedResult } from '@core/types/pagination';

// Accessors
import type { ITankAccessor } from '../contracts/tank.accessor.interface';
import { TANK_ACCESSOR } from '../contracts/tank.accessor.interface';
import type { IFishAccessor } from '../contracts/fish.accessor.interface';
...
import type { ISetupTankAccessor } from '../contracts/setup-tank.accessor.interface';
import { SETUP_TANK_ACCESSOR } from '../contracts/setup-tank.accessor.interface';

// Exceptions
import { TankNotFoundException } from '../exceptions/tank-not-found.exception';
...
import {
  ...
  TankSetupSuggestion,
} from '../engines/suggestion-tank-idea.engine';
import {
  CompatibilityEngine,
...
export class AquariumManager {
  ...
  async setupTank(ideas: string): Promise<TankSetupSuggestion> {
    ...
    const systemInstruction =
      this.suggestionTankIdeaEngine.getSystemInstruction();
